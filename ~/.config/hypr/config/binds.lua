...
hl.bind(mainMod .. " + C",           hl.dsp.window.fullscreen({ mode = 1 }))
...
-- Audio
hl.bind("Page_Up", hl.dsp.exec_cmd(noctCall .. "volume-up"),   { locked = true, repeating = true })
hl.bind("Page_Down", hl.dsp.exec_cmd(noctCall .. "volume-down"), { locked = true, repeating = true })
hl.bind("End", hl.dsp.exec_cmd(noctCall .. "volume-mute"), { locked = true })
...
hl.bind("CONTROL + bracketleft", hl.dsp.exec_cmd(noctCall .. "screenshot-region"))
...
-- Clipboard
hl.bind("CONTROL + bracketright", hl.dsp.exec_cmd(noctCall .. "panel-toggle clipboard"))
